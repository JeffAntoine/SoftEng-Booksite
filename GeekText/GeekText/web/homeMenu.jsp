      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="userLogin.jsp">Log In</a>
            </li>
             <li>
            	<font color="white" ><i> Welcome, ${username} </i></font>
            	<font color= "white" > <a class="nav-link text-uppercase text-expanded" href="userProfile.jsp" > Profile </a></font>
